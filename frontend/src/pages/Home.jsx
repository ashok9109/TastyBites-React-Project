    ...
    <>
        <div className="flex flex-col-reverse md:flex-row gap-10 overflow-x-hidden py-10 px-4 sm:px-6 md:px-10 max-w-screen h-auto md:h-screen  text-green-500">
          <div className="w-full md:w-[60%] text-center md:text-left">
            <h1 className="text-lg sm:text-xl">Welcome to Tasty-Bites</h1>
            <h1 className="font-[Open_Sans] tracking-wider text-white text-4xl sm:text-6xl md:text-8xl mt-6 md:mt-10 mb-6 md:mb-10 md:pl-10">
              Expl
        ...
        <div>
          <div className="py-10 px-4 sm:px-6 md:px-10 text-center  ">
            ...
            <h1 className="text-4xl sm:text-6xl md:text-8xl mt-10 text-gray-300">
